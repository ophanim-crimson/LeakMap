          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              {report.ai_urgency && report.ai_urgency !== 'Pending' && (
                <Tag 
                  color={report.ai_urgency === 'Critical' ? '#ff4d4f' : report.ai_urgency === 'High' ? '#faad14' : report.ai_urgency === 'Medium' ? '#1890ff' : 'default'} 
                  style={{ borderRadius: '12px', padding: '2px 10px', margin: 0, fontWeight: 500 }}
                >
