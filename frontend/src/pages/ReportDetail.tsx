...
import { fetchReportById, addComment, Report } from '../api';
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col xs={24} md={14}>
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            <Card 
              title={<div style={{ fontSize: '15px' }}><EnvironmentOutlined /> {t('Location Map') || 'Location Map'}</div>}
              extra={
                <Button 
                  type="text" 
        ...
        <Col xs={24} md={10}>
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            {/* Comment to Admin Form */}
            {user && (
              <Card 
                title={<div style={{ fontSize: '15px' }}>💬 {t('Add Comment to Admin') || 'Add Comment to Admin'}</div>}
              ...
              >
                <Input.TextArea
                  ...
                  placeholder="Describe additional details about this issue..."
                  rows={3}
                  maxLength={1000}
                ...
                >
                  {t('Submit Comment') || 'Submit Comment'}
                </Button>
              </Card>
            )}
